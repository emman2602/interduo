...
export function ForgotPasswordForm({
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      // La URL que se incluirá en el correo. Esta URL debe estar configurada en las URLs de redirección de tu panel de Supabase en https://supabase.com/dashboard/project/_/auth/url-configuration
      ...
      {success ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Se enviaron las instrucciones para restablecer tu contraseña</CardDescription>
          </CardHeader>
          <CardContent>
